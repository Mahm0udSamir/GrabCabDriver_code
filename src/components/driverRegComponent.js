...
export default class DiverReg extends React.Component {
    ...
    validatePassword() {
        ...
        if(complexity == 'any') {
            ...
            this.setState({pwdErrorMsg: 'Password must be atleast 1 Capital letter,1 small-case letter, 1 digit and 1 special character with 6-10 length'})
        }
        LayoutAnimation.easeInEaseOut()
                        ...
                        <View style={styles.containerStyle}>
                            ...
                            <View style={styles.textInputContainerStyle}>
                                ...
                                <Input
                                    ...
                                    errorMessage={this.state.mobileValid ? null : 'Please enter mobile number'}
                                    secureTextEntry={false}
                                    blurOnSubmit={true}
                            ...
                            <View style={styles.textInputContainerStyle}>
                                ...
                                <Input
                                    ...
                                    errorMessage={this.state.vehicleNameValid ? null : 'Vehicle Name Can\'t be blank'}
                                    blurOnSubmit={true}
                            ...
                            <View style={styles.textInputContainerStyle}>
                                ...
                                <Input
                                    ...
                                    errorMessage={this.state.vehicleNumValid ? null : 'Vehicle number Can\'t be blank'}
                                    blurOnSubmit={true}
