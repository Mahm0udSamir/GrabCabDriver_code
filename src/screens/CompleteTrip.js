...
export default class DriverCompleteTrip extends React.Component {
    ...
    async onPressEndTrip(item) {
        ...
        if(location) {
            ...
            let destLoc = '"'+pos.latitude+', '+pos.longitude+'"';
              ...
              if(fareCalculation) {
                this.finalCostStore(item,fareCalculation.grandTotal,pos,respJson.routes[0].legs[0].distance.value)
    ...
    finalCostStore(item,finalFare,pos,distance){
        var data = {
            status:"END",
    ...
    sendPushNotification(customerUID,bookingId){
        ...
        customerRoot.once('value',customerData=>{
            if(customerData.val()){
                ...
                RequestPushMsg(allData.pushToken?allData.pushToken:null,'Driver has Completed your ride. your booking id is'+bookingId)
            }
        })
    }
           ...
           <Modal
               ...
               <View style={{flex: 1, backgroundColor: "rgba(22,22,22,0.8)", justifyContent: 'center', alignItems: 'center' }}>
                   ...
                   <View style={{ alignItems: 'center',flexDirection:'row',flex:1,justifyContent:"center"}}>
                        ...
                        />
                      <View style={{flex:1}}>
                            <Text style={{color:"#000",fontSize:16,}}>Calculating your fare</Text>
                       </View>
                   </View>
                   </View>
               </View>
