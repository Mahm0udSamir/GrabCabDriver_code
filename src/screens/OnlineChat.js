...
sendMessege(inputmessage){
  ...
  renderItem({ item }) {
    return (
          ...
          <Text style={styles.msgTextStyle}>{item?item.message:"No chat history found"}</Text>
          <Text style={styles.msgTimeStyle}>{item?item.msgTime:null}</Text>
          </View>
          :
          <View style={styles.riderMsgStyle}>
          <Text style={styles.riderMsgText}>{item?item.message:"No chat history found"}</Text>
  ...
  return (
    <View style={styles.container}>
        <Header 
            ...
            centerComponent={<Text style={styles.headerTitleStyle}>Chat</Text>}
