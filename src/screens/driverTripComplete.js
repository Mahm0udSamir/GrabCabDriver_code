    ...
    sendPushNotification(customerUID,bookingId){
        ...
        customerRoot.once('value',customerData=>{
            if(customerData.val()){
                ...
                RequestPushMsg(allData.pushToken?allData.pushToken:null,'Driver has requested for payment. your booking id is'+bookingId)
            }
        })
    }
        ...
        return(
            <View style={styles.mainViewStyle}>
                ...
                <View style={styles.rateViewStyle}>
                    <Text style={styles.rateViewTextStyle}>{this.state.trip_cost ? "$"+this.state.trip_cost.toFixed(2) :"$"+ 0}</Text>
                </View>
